...
Walk the project read-only — use the Agent tool with `subagent_type=Explore`. Don't follow rigid heuristics — explore organically and note where you experience friction:
