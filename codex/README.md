...
8 skills for OpenAI Codex (CLI, IDE extension, app).
...
**Skills:** `agent-evals`, `ask-claude`, `implement-issues`, `improve-project-structure`, `loop-creator`, `project-review`, `review-loop`, `verify-before-done`.
